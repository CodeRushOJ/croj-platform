...
完整变更记录位于仓库根目录的 [`CHANGELOG.md`](https://github.com/CodeRushOJ/croj-platform/blob/main/CHANGELOG.md)。其中 `0.0.1` 是根据原仓库 Git 历史重建的 2025 原型里程碑，不冒充当时存在的统一标签；`0.1.0` 是平台底座版本，`1.0.0`、`1.0.1` 和 `1.0.2` 保留为发布链路失败的审计标签，`1.0.3` 是当前正式版本。
